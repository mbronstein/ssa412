...
class AbstractMergeManager(object):
    ...
    parameters passed in constructor:
        ...
        form_filename (filename of form template)
        form_dirpath (location of forms)
        output_dirpath(folder created file will go in) # or return as stream
   """
    __metaclass__ = ABCMeta

    def __init__(self, form_filename=None,
                 form_file=None,
                 form_stream=None,
                 output_stream=None,
                 output_file=None,
